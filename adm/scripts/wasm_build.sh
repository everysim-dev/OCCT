...
-D3RDPARTY_FREETYPE_INCLUDE_DIR_ft2build:FILEPATH="/usr/include/freetype2" \
-D3RDPARTY_FREETYPE_INCLUDE_DIR_freetype2:FILEPATH="/usr/include/freetype2/freetype" \
-D3RDPARTY_FREETYPE_LIBRARY_DIR:PATH="/usr/lib/x86_64-linux-gnu" \
-D3RDPARTY_FREETYPE_LIBRARY:FILEPATH="/usr/lib/x86_64-linux-gnu/libfreetype.so" \
